...
<div class="main-content-wrap">
    @include('admin.layouts.partials.breadcrumb', ['header' => "Update Category"])
    <!-- new-category -->
    <div class="wg-box">
        <form class="form-new-product form-style-1" action="{{ route('admin.category.update', $category->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <fieldset class="name">
                ...
                <input class="flex-grow" type="text" placeholder="Category Slug" name="slug"
                    tabindex="0" value="{{old('slug', $category->name)}}" aria-required="true" required>
                ...
                <div class="upload-image flex-grow">
                    <div class="item" id="imgpreview">
                        <div class="display-input-image">
                            <img src="{{ $category->getThumbnailImage() }}"
                                alt="Preview Image" />
                            <button type="button"
